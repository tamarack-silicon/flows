...
.PHONY: lint-tb
lint-tb:
	$(SLANG) $(SLANG_TB_LINT_ARGS) $(STDCELL_SRAM_BEHAV_VERILOG) $(RTL_FLIST_ARG) $(TB_FILE) --top $(TB_NAME)

.PHONY: lint-verif
lint-verif:
	$(SLANG) $(SLANG_VERIF_LINT_ARGS) $(STDCELL_SRAM_BEHAV_VERILOG) $(UVM_PKG_ARGS) $(RTL_FLIST_ARG) $(VERIF_FLIST_ARG) --top $(VERIF_TOP_NAME)
...
sim/$(TB_NAME)_obj_dir/V$(TB_NAME):
	mkdir -p sim
	$(VERILATOR) --cc --exe --main $(VL_TB_SIM_ARGS) --top $(TB_NAME) $(STDCELL_SRAM_BEHAV_VERILOG) $(RTL_FLIST_ARG) $(TB_FILE) -Mdir sim/$(TB_NAME)_obj_dir
...
sim/verif_obj_dir/V$(VERIF_TOP_NAME):
	mkdir -p sim
	$(VERILATOR) --cc --exe --main $(VL_VERIF_SIM_ARGS) --top $(VERIF_TOP_NAME) $(STDCELL_SRAM_BEHAV_VERILOG) $(UVM_PKG_ARGS) $(RTL_FLIST_ARG) $(VERIF_FLIST_ARG) -Mdir sim/verif_obj_dir
